...
public class AccessControlRecord implements ApiMessage {
    ...
    public static final Schema SCHEMA_0 =
        new Schema(
            ...
            new Field("resource_name", Type.NULLABLE_STRING, "The resource name, or null if this is for the default resource."),
            new Field("pattern_type", Type.INT8, "The pattern type (literal, prefixed, etc.)"),
            new Field("principal", Type.STRING, "The principal name."),
            new Field("host", Type.STRING, "The host."),
