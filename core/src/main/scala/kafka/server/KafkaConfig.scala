...
object Defaults {
  ...
  val RemoteLogMetadataTopicReplicationFactor = TopicBasedRemoteLogMetadataManagerConfig.DEFAULT_REMOTE_LOG_METADATA_TOPIC_REPLICATION_FACTOR
  val RemoteLogMetadataTopicPartitions = TopicBasedRemoteLogMetadataManagerConfig.DEFAULT_REMOTE_LOG_METADATA_TOPIC_PARTITIONS
  val RemoteLogMetadataTopicRetentionMillis = TopicBasedRemoteLogMetadataManagerConfig.DEFAULT_REMOTE_LOG_METADATA_TOPIC_RETENTION_MILLIS
...
object KafkaConfig {
  ...
  val RemoteLogMetadataTopicReplicationFactorProp = TopicBasedRemoteLogMetadataManagerConfig.REMOTE_LOG_METADATA_TOPIC_REPLICATION_FACTOR_PROP
  val RemoteLogMetadataTopicPartitionsProp = TopicBasedRemoteLogMetadataManagerConfig.REMOTE_LOG_METADATA_TOPIC_PARTITIONS_PROP
  val RemoteLogMetadataTopicRetentionMillisProp = TopicBasedRemoteLogMetadataManagerConfig.REMOTE_LOG_METADATA_TOPIC_RETENTION_MILLIS_PROP
  ...
  private[server] val configDef = {
    ...
    new ConfigDef()
      ...
      /** ********** Default Remote log metadata manager configuration ********* */
      .define(RemoteLogMetadataTopicReplicationFactorProp, INT, Defaults.RemoteLogMetadataTopicReplicationFactor, atLeast(1), LOW, RemoteLogMetadataTopicReplicationFactorDoc)
      .define(RemoteLogMetadataTopicPartitionsProp, INT, Defaults.RemoteLogMetadataTopicPartitions, atLeast(1), LOW, RemoteLogMetadataTopicPartitionsDoc)
