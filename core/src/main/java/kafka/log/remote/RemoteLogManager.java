...
public class RemoteLogManager implements Closeable {
    ...
    public RemoteLogManager(RemoteLogManagerConfig rlmConfig,
        ...
        remoteStorageOffsetReaderThreadPool = new RemoteStorageOffsetReaderThreadPool(
                REMOTE_LOG_OFFSET_READER_THREAD_NAME_PATTERN,
    ...
    void deleteRemoteLogPartition(TopicIdPartition partition) throws RemoteStorageException, ExecutionException, InterruptedException {
        ...
        remoteLogStorageManager.deletePartition(partition, metadataList);
    ...
    class RLMCopyTask extends RLMTask {
        ...
        private void copyLogSegment(UnifiedLog log, LogSegment segment, RemoteLogSegmentId segmentId, long nextSegmentBaseOffset)
            ...
            RemoteStorageProvider storageProvider = RemoteStorageProvider.fromName(log.config().remoteStorageProvider());
            ...
            LogSegmentData segmentData = new LogSegmentData(logFile.toPath(), toPathIfExists(segment.offsetIndex().file()),
                    ...
                    producerStateSnapshotFile.toPath(), leaderEpochsIndex, storageProvider);
