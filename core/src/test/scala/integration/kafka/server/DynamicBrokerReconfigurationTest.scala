...
import org.apache.kafka.server.config.{ConfigType, KRaftConfigs, ReplicationConfigs, ServerConfigs, ServerLogConfigs, ServerTopicConfigSynonyms, ZkConfigs}
...
class DynamicBrokerReconfigurationTest extends QuorumTestHarness with SaslSetup {
  ...
  @MethodSource(Array("getTestQuorumAndGroupProtocolParametersKraftOnly"))
