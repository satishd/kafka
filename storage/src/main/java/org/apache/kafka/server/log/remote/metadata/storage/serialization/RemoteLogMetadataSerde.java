...
public class RemoteLogMetadataSerde {
    ...
    public static class Serializer implements org.apache.kafka.common.serialization.Serializer<RemoteLogMetadata> {
        private final RemoteLogMetadataSerde serde = new RemoteLogMetadataSerde();

        @Override
        public byte[] serialize(String topic,
                                RemoteLogMetadata remoteLogMetadata) {
            return serde.serialize(remoteLogMetadata);
        }
    }

    public static class Deserializer implements org.apache.kafka.common.serialization.Deserializer<RemoteLogMetadata> {

        private final RemoteLogMetadataSerde serde = new RemoteLogMetadataSerde();

        @Override
        public RemoteLogMetadata deserialize(String topic,
                                             byte[] data) {
