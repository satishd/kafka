...
public final class TopicBasedRemoteLogMetadataManagerConfig {
    ...
    public static final String REMOTE_LOG_METADATA_CONSUME_WAIT_MS = "remote.log.metadata.consume.wait.ms";
    ...
    public TopicBasedRemoteLogMetadataManagerConfig(Map<String, ?> props) {
        ...
        Object consumeWaitMsVal = props.get(REMOTE_LOG_METADATA_CONSUME_WAIT_MS);
        consumeWaitMs = consumeWaitMsVal != null ? (Long) consumeWaitMsVal : DEFAULT_REMOTE_LOG_METADATA_CONSUME_WAIT_MS;
        metadataTopicPartitionsCount =
                Integer.parseInt(props.get(TopicBasedRemoteLogMetadataManagerConfig.REMOTE_LOG_METADATA_TOPIC_PARTITIONS_PROP).toString());
