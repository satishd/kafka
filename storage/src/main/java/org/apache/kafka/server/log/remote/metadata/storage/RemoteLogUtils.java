...
public class RemoteLogUtils {
    public static final Logger log = LoggerFactory.getLogger(RemoteLogUtils.class);

    public static int metadataPartitionFor(TopicIdPartition topicIdPartition, int noOfMetadataTopicPartitions) {
