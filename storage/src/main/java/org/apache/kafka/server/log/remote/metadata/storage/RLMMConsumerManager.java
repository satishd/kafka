...
public class RLMMConsumerManager implements Closeable {

    private static final Logger log = LoggerFactory.getLogger(RLMMConsumerManager.class);
    ...
    public RLMMConsumerManager(TopicBasedRLMMConfig rlmmConfig,
        ...
        consumerTask = new ConsumerTask(consumer, remotePartitionMetadataEventHandler, rlmmConfig.metadataTopicPartitionsCount());
        consumerTaskThread = KafkaThread.daemon("RLMM-Consumer-Task", consumerTask);
    }
    ...
    public void waitTillConsumptionCatchesUp(RecordMetadata recordMetadata) {
        ...
        while (true) {
            ...
            if (time.milliseconds() - startTimeMillis > 120_000) {
