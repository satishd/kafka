...
import static org.apache.kafka.server.log.remote.metadata.storage.TopicBasedRLMMConfig.REMOTE_LOG_METADATA_COMMON_CLIENT_PREFIX;
import static org.apache.kafka.server.log.remote.metadata.storage.TopicBasedRLMMConfig.REMOTE_LOG_METADATA_CONSUMER_PREFIX;
import static org.apache.kafka.server.log.remote.metadata.storage.TopicBasedRLMMConfig.REMOTE_LOG_METADATA_PRODUCER_PREFIX;
...
public class TopicBasedRLMMConfigTest {
    ...
    public void testInvalidConfig() throws Exception {
        // "bootstrap.servers" config is required, it will throw InvalidConfigurationException if it does not exist.
        Assertions.assertThrows(InvalidConfigurationException.class, () -> new TopicBasedRLMMConfig(Collections.emptyMap()));
    }
    ...
    public void testValidConfig() {
        ...
        TopicBasedRLMMConfig rlmmConfig = new TopicBasedRLMMConfig(props);
