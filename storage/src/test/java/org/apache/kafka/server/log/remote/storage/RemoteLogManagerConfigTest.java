    ...
    public void testValidConfigs() {
        ...
        RemoteLogManagerConfig expectedRemoteLogManagerConfig
                = new RemoteLogManagerConfig(true, "dummy.remote.storage.class", "dummy.remote.storage.class.path",
                                             ...
                                             "listener.name", 1024 * 1024L, 1, 60000L, 100L, 60000L, 1000L, 10, 100,
                                             rsmProps, rlmmProps);

        Map<String, Object> props = extractProps(expectedRemoteLogManagerConfig);
        rsmProps.forEach((k, v) -> props.put(RemoteLogManagerConfig.REMOTE_STORAGE_MANAGER_CONFIG_PREFIX + k, v));
        rlmmProps.forEach((k, v) -> props.put(RemoteLogManagerConfig.REMOTE_LOG_METADATA_MANAGER_CONFIG_PREFIX + k, v));
