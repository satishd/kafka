 ...
 *    The purpose of this test is to verify that an empty broker on becoming leader for a remote storage enabled topic
 ...
 *    - An empty broker is started and assigned leadership;
 *
 *    Acceptance:
 *    -----------
 *    - The new broker should be able to retrieve records for all valid offsets
 */
public class FollowerFetchRequestForEmptyBrokerTest extends TieredStorageTestHarness {
    ...
    protected void writeTestSpecifications(TieredStorageTestBuilder builder) {
        ...
        builder
            ...
            // Bring up an empty broker (stop -> delete data -> start)
            .stop(broker1)
            .eraseBrokerStorage(broker1, (dir, name) -> !name.contains("meta.properties"), true)
            .start(broker1)
            // Ensure the new broker can become a leader
