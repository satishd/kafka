...
public class RemoteLogSegmentMetadata implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return startOffset == that.startOffset && endOffset == that.endOffset && leaderEpoch == that.leaderEpoch
    ...
    @Override
    public int hashCode() {
        return Objects.hash(remoteLogSegmentId, startOffset, endOffset, leaderEpoch, maxTimestamp, eventTimestamp,
