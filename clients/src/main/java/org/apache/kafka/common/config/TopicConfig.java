...
public class TopicConfig {
    ...
    public static final String REMOTE_LOG_STORAGE_ENABLE_DOC = "o enable tier storage for a topic, set remote.log.storage.enable as true. " +
    ...
    public static final String LOCAL_LOG_RETENTION_MS_DOC = "The number of milli seconds to keep the local log segment before it gets deleted. " +
            "If not set, the value in `retention.ms` is used. The effective value should always be less than or equal to retention.ms value.";
    ...
    public static final String LOCAL_LOG_RETENTION_BYTES_DOC = "The maximum size of local log segments that can grow for a partition before it " +
            "deletes the old segments. If not set, the value in `retention.bytes` is used. The effective value should always be less than or equal" +
            " to retention.bytes value.";
