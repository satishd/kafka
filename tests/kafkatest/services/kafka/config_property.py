...
REMOTE_LOG_STORAGE_ENABLE="remote.log.storage.enable"
...
REMOTE_LOG_METADATA_TOPIC_NUM_PARTITIONS="remote.log.metadata.topic.num.partitions"
REMOTE_LOG_METADATA_TOPIC_REPLICATION_FACTOR="remote.log.metadata.topic.replication.factor"
REMOTE_LOG_METADATA_TOPIC_RETENTION_MS="remote.log.metadata.topic.retention.ms"
...
REMOTE_LOG_RETENTION_BYTES="remote.log.retention.bytes"
REMOTE_LOG_RETENTION_MS="remote.log.retention.ms"
REMOTE_LOG_STORAGE_HDFS_FS_URI="remote.log.storage.hdfs.fs.uri"
REMOTE_LOG_STORAGE_HDFS_BASE_DIR="remote.log.storage.hdfs.base.dir"
REMOTE_LOG_STORAGE_HDFS_REMOTE_READ_BYTES_MB="remote.log.storage.hdfs.remote.read.bytes.mb"
